...
with st.container(key="demo_toolbar"):
    toolbar_logo, toolbar_brand, toolbar_merchant, toolbar_status, toolbar_notifications = st.columns(
        [0.45, 1.9, 1.5, 2.75, 1.45], vertical_alignment="center"
    )
    with toolbar_logo:
...
if incident is None:
    ...
    render_incident_assistant(API_BASE_URL, merchant, incident["incident_id"])
